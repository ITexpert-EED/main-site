...
const items = [
  {
    src: "/images/product/MCC-removebg-preview.png",
...
export default function ProductDetails({ productsItem }) {
          ...
          <div className="col-md-7 col-lg-7 col-sm-12">
            ...
            >
              <div className="dlab-post-title">
                ...
                <p className="m-b10">
                  Motor Control Centre Panels (MCC Panels) are used to control
                  motors from a central location in large industrial and
                  commercial applications. Its primary function is to centralize
                  all devices and equipment dedicated to the protection and
                  control of plant motors in order to facilitate their use even
                  when staff is limited.
                </p>
              ...
              <div className="tab-content">
                <div id="web-design-1" className="tab-pane active">
                  <p className="m-b10">
                    Motor Control Centre Panels (MCC Panels) are used to control
                    motors from a central location in large industrial and
                    commercial applications. Its primary function is to
                    centralize all devices and equipment dedicated to the
                    protection and control of plant motors in order to
                    facilitate their use even when staff is limited.
                  </p>
                
                  <ul className="list-check primary">
                    <li>Remote control operation facility</li>
                    <li>MCCB for protection</li>
                    <li>Change over switch for circuit change from mains to DG and vice-versa</li>
                    <li>Direct on line starters that includes MCB, contactor, thermal overload relay and connectors.</li>
                    <li>Bus Bars of proper rating duly covered with acrylic sheet for safety.</li>
                    <li>Aluminium strip for earthing</li>
                    <li>Panel light and fan for ventilation.</li>
                    <li>Many more features that solves many practical problems.</li>
                  ...
                  <table className="table table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Wall Mounted / Floor Standing</td>
                      </tr>
                      <tr>
                        <td>Enclosure</td>
                        <td>
