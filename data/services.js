export const services = [
  {
    ...
    description:
      "Every panel we manufacture is designed and built to the highest industry standards, ensuring maximum safety, durability, and efficiency.",
  },
  {
    id: 2,
    ...
    description:
      "We understand that no two businesses are alike. That’s why we offer custom-built electrical panels to meet your specific requirements, no matter the scale or complexity of your project.",
  },
  {
    id: 3,
    ...
    description:
      "With years of experience and a team of skilled professionals, we combine human expertise with cutting-edge technology to deliver results that exceed expectations.",
  },
  {
    id: 4,
    ...
    imageSrc: "/images/our-services/pic3.jpg",
    description:
      " From the moment you reach out to us, we provide exceptional customer service and technical support to ensure your needs are met at every stage of the process.",
  },
  {
    id: 5,
    ...
    imageSrc: "/images/our-services/pic2.jpg",
    description:
      "We continuously strive to improve and innovate, adopting the latest technologies to provide smarter, more efficient solutions.",
  },
  // {
  //   id: 6,
